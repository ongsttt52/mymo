...
public class MemoController {
  ...
  public ResponseEntity<MemoResponse> createMemo(
      @CurrentMemberId Long memberId, @Valid @RequestBody MemoCreateRequest request) {
  ...
  @DeleteMapping("/{id}")
  public ResponseEntity<Void> deleteMemo(@CurrentMemberId Long memberId, @PathVariable Long id) {
