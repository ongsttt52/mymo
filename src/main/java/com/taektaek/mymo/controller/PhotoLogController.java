...
public class PhotoLogController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PhotoLogResponse> getPhotoLog(@PathVariable Long id) {
        PhotoLogResponse response = photoLogService.getPhotoLog(id);
        return ResponseEntity.ok(response);
    }

    @GetMapping
    public ResponseEntity<List<PhotoLogResponse>> getPhotoLogsByMember(@RequestParam Long memberId) {
    ...
    public ResponseEntity<PhotoLogResponse> updatePhotoLog(
        ...
        PhotoLogResponse response = photoLogService.updatePhotoLog(id, request);
        return ResponseEntity.ok(response);
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deletePhotoLog(@PathVariable Long id) {
