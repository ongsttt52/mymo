...
class MusicLogRepositoryTest {
    ...
    void findByMemberIdOrderByDateDesc() {
        // given
        musicLogRepository.save(new MusicLog("곡1", "가수1", null, null, null, null, LocalDate.of(2026, 3, 1), member));
        musicLogRepository.save(new MusicLog("곡2", "가수2", null, null, null, null, LocalDate.of(2026, 3, 3), member));
        musicLogRepository.save(new MusicLog("곡3", "가수3", null, null, null, null, LocalDate.of(2026, 3, 2), member));
    ...
    void findByMemberIdOrderByDateDesc_otherMember() {
        // given
        Member otherMember = memberRepository.save(new Member("other", "other@example.com", "password123"));
        musicLogRepository.save(new MusicLog("내 곡", "가수", null, null, null, null, LocalDate.of(2026, 3, 1), member));
        musicLogRepository.save(new MusicLog("다른 곡", "가수", null, null, null, null, LocalDate.of(2026, 3, 1), otherMember));
